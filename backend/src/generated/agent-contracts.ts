...
export const maskBornAccountV2Abi = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "error",
    "name": "InvalidCheckpointCategory",
    "inputs": []
  },
  {
    "type": "error",
